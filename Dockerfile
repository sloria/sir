FROM python:2.7
# We need both Python 2 and 3 installed because node-gyp requires py2. The API requires py3.

##### NODE #####
# https://github.com/nodejs/docker-node/blob/9992908b275546d9dc1b6063a4d0b7bc500e8b3b/4.2/Dockerfile
...
COPY ./compose/api/gunicorn.sh /gunicorn.sh
